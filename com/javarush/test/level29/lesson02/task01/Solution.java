...
public class Solution {
    ...
    public boolean FileExpectedLine(String expectedLine) {
    ...
    public static void main(String[] args) throws FileNotFoundException {
        ...
        if (solution.isFileLoaded()) {
            System.out.println(solution.FileExpectedLine("public class Solution {"));   //expected true
            System.out.println(solution.FileExpectedLine(" public class Solution {"));  //expected false
        }
    }
}
